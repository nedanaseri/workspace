...
var months = ["Januaray", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
...
h2.innerHTML = "".concat(day, ", ").concat(date, " ").concat(month, " ").concat(year, " | ").concat(hours, ":").concat(minutes, ":").concat(seconds);
function citySearch() {
  var cityInput = document.querySelector("#city-input");
  var h1 = document.querySelector("h1");
  if (cityInput.value) {
    h1.innerHTML = "".concat(cityInput.value, " Weather");
  } else {
    alert("Enter a city");
  }
}
...
function cityWeather() {
  ...
  citySearch();
  var apiKey = "1fd8093fa5ff12d796d7de756cc9d6b9";
  var apiUrl = "https://api.openweathermap.org/data/2.5/weather?q=".concat(cityName.value, "&appid=").concat(apiKey, "&units=metric");
  axios.get(apiUrl).then(showWeather);
}
function showWeather(response) {
  var currentTemp = Math.round(response.data.main.temp);
  var tempElement = document.querySelector("#temperature");
  tempElement.innerHTML = "".concat(currentTemp, "\xB0C");
  var h1 = document.querySelector("h1");
  h1.innerHTML = "".concat(response.data.name, " Weather");
